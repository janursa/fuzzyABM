...
settings = {
    ...
    #        },
    "agents_traj": {
            "graph_dir" : "/Users/matin/Downloads/testProjs/ABM_extension/build/outputs/agents_traj.csv",
            "graph_type" : 'lines',
            'x-axis-moves': False
           },
   "pH": {
		    "graph_dir" : "/Users/matin/Downloads/testProjs/ABM_extension/build/outputs/pH.csv",
		    "graph_type" : 'lines',
		    'x-axis-moves': False
		   }
}
